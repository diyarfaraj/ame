      ...
      >
        ...
        <div className="flex gap-4 mt-12">
          ...
          <button
            ...
            className="flex-1 bg-stone-800 text-white px-8 py-4 uppercase tracking-widest text-sm hover:bg-stone-700 transition-colors duration-300 inline-flex items-center justify-center gap-2"
          >
            Submit
