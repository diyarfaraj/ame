...
export default function ProjectsSection() {
  ...
  return (
    <section ref={ref} className="min-h-screen">
      {/* Top Half - Beige Background with Projects */}
      <div className="bg-[#D7D1C8] px-6 md:px-12 py-24 md:py-32">
      ...
      {/* Bottom Half - White Background with Testimonial */}
      <div className="bg-white px-6 md:px-12 py-24 md:py-32">
        <div className="max-w-7xl mx-auto w-full">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
